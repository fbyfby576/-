...
const weeks = [
  {
    ...
    shopping: ["鸡蛋 14个（约700g）", "燕麦 300g/袋（本周用160g）", "全麦面包 1袋（约500g，8-10片）", "无糖高钙豆浆 1L 或无乳糖酸奶 400g", "金枪鱼罐头 1罐（沥干约100g）", "冻鲭鱼 2片（150g/片，共300g）", "黑虎虾仁 500g（本周用480g）", "牛肉 400g", "鸡腿肉 300g", "豆腐 1盒（400g/盒；周四200g、周六200g用完；周二豆腐属于上个买菜周期剩余）", "全麦意面 250g/包（本周用70g干重）", "荞麦面 300g/包（本周用70g干重，外食另算）", "菠菜 450g", "西兰花 400g", "生菜 300g", "番茄 500g", "洋葱 200g", "彩椒 150g", "黄瓜 200g", "香菇/蘑菇 200g", "蓝莓 150g", "猕猴桃 2个（约200g）", "南瓜子/坚果 150g"],
    days: [
      ["周一", "游泳日", "鸡蛋 2个（约100g） + 燕麦 40g干重 + 蓝莓 50g + 菠菜 100g", "外食：番茄荞麦面，牛肉 100g 或鸡蛋 1个，熟荞麦面约150g，配菜 150g，汤不喝完", "鲭鱼 150g + 蒜蓉西兰花 200g + 洋葱 50g + 生菜 80g"],
      ...
      ["周三", "游泳日", "鸡蛋 2个（约100g） + 全麦面包 1片（约35g） + 黄瓜 100g + 番茄 100g", "外食：番茄荞麦面，蛋白 100g，熟荞麦面约150g，配菜 150g，先吃蛋白和配菜", "虾仁 120g + 番茄 150g + 菠菜 150g + 紫甘蓝 100g"],
      ["周四", "哑铃日", "燕麦 40g干重 + 鸡蛋 2个（约100g） + 猕猴桃 1个（约100g）", "牛肉 120g + 西兰花 200g + 全麦意面 70g干重", "虾仁豆腐煲：虾仁 120g + 豆腐 200g（半盒） + 生菜 100g"],
      ["周五", "游泳日", "鸡蛋开放三明治：鸡蛋 2个（约100g） + 全麦面包 1片（约35g） + 生菜 80g", "外食：番茄荞麦面；应急麦当劳选牛肉/鸡腿堡 1个，去半片面包，不配薯条甜饮", "鲭鱼 150g + 彩椒 100g + 洋葱 50g + 凉拌菠菜 150g"],
      ["周六", "恢复/放纵", "鸡蛋 2个（约100g） + 燕麦 40g干重 + 蓝莓 50g", "牛肉 100g + 豆腐 200g（周四开盒剩余半盒，当天吃完） + 生菜 120g + 番茄 100g + 全麦面包 1片（约35g）", "放纵餐前垫底：蛋白 120g + 蔬菜 200g；正餐按八分饱"],
  ...
  },
  {
    ...
    shopping: ["鸡蛋 12个（约600g）", "燕麦 300g/袋（本周用120g）", "无糖高钙豆浆 1L 或无乳糖酸奶 400g", "冻鲭鱼 1片（150g）", "金枪鱼罐头 2罐（沥干约200g）", "黑虎虾仁 400g", "鸡腿肉 700g", "牛肉 300g", "豆腐 1盒（400g/盒；周六200g、周日200g用完；周二豆腐属于上个买菜周期剩余）", "鹰嘴豆 2罐（沥干约480g，本周用220g）", "全麦面包 1袋（约500g）", "全麦意面 250g/包（本周用70g干重）", "生菜 500g", "菠菜 300g", "番茄 700g", "黄瓜 250g", "彩椒 250g", "西葫芦 150g", "蘑菇 200g", "紫甘蓝 100g", "蓝莓 100g", "草莓 100g"],
    days: [
      ["周一", "游泳日", "鸡蛋 2个（约100g） + 燕麦 40g干重 + 蓝莓 50g", "外食：番茄荞麦面，加鸡蛋 1个，熟荞麦面约150g，配菜 150g", "金枪鱼罐头 1罐（沥干约100g） + 生菜 120g + 番茄 150g + 鹰嘴豆 60g"],
      ...
      ["周三", "游泳日", "燕麦 40g干重 + 鸡蛋 2个（约100g） + 草莓 100g", "外食：番茄荞麦面，加牛肉 100g，熟荞麦面约150g，配菜 150g", "鸡腿肉 150g + 蘑菇 100g + 紫甘蓝 100g + 生菜 100g"],
      ...
      ["周五", "游泳日", "鸡蛋 2个（约100g） + 菠菜 100g + 全麦面包 1片（约35g）", "外食：番茄荞麦面，熟面约150g，蛋白 100g，配菜 150g", "鲭鱼 150g + 彩椒 100g + 洋葱 50g + 黄瓜 100g"],
      ["周六", "恢复/放纵", "燕麦 40g干重 + 鸡蛋 2个（约100g） + 蓝莓 50g", "豆腐 200g（半盒） + 牛肉 100g + 番茄 200g + 生菜 100g", "放纵餐前垫底：蛋白 120g + 蔬菜 200g"],
  ...
  },
  {
    ...
    shopping: ["鸡蛋 14个（约700g）", "燕麦 300g/袋（本周用120g）", "金枪鱼罐头 1罐（沥干约100g）", "鲭鱼 2片（150g/片，共300g）", "黑虎虾仁 500g", "牛肉 500g", "鸡腿肉 400g", "豆腐 1盒（400g/盒；周四200g、周六200g用完；周一、周二豆腐属于上个买菜周期剩余）", "荞麦面 300g/包（本周用180g干重，外食另算）", "全麦面包 1袋（约500g）", "紫菜/海带芽 30g", "泡菜 200g", "菠菜 450g", "生菜 450g", "西兰花 200g", "紫甘蓝 100g", "蘑菇 300g", "黄瓜 200g", "番茄 400g", "彩椒 100g", "猕猴桃 2个（约200g）", "蓝莓 50g"],
    days: [
      ...
      ["周六", "恢复/放纵", "鸡蛋 2个（约100g） + 燕麦 40g干重", "豆腐鸡蛋蔬菜锅：豆腐 200g（周四开盒剩余半盒，当天吃完） + 鸡蛋 1个 + 生菜 120g + 蘑菇 100g", "放纵餐前垫底：蛋白 120g + 蔬菜 200g"],
  ...
  },
  {
    ...
    shopping: ["鸡腿肉 900g", "豆腐 1盒（400g/盒；周四200g、周六200g用完；周二、周三豆腐属于上个买菜周期剩余）", "鸡蛋 14个（约700g）", "金枪鱼罐头 1罐（沥干约100g）", "黑虎虾仁 500g", "鲭鱼 2片（150g/片，共300g）", "牛肉 300g", "毛豆或鹰嘴豆 300g", "燕麦 300g/袋（本周用120g）", "全麦面包 1袋（约500g）", "荞麦面 300g/包（本周用70g干重，外食另算）", "西兰花 400g", "菠菜 300g", "生菜 500g", "番茄 350g", "彩椒 250g", "蘑菇 200g", "洋葱 100g", "黄瓜 100g", "紫甘蓝 100g", "猕猴桃 1个（约100g）", "橙 1个（约150g）", "蓝莓 50g"],
    days: [
      ...
      ["周六", "恢复/放纵", "鸡蛋 2个（约100g） + 燕麦 40g干重", "鸡腿肉 120g + 豆腐 200g（周四开盒剩余半盒，当天吃完） + 生菜 150g + 全麦面包 1片（约35g）", "放纵餐前垫底：蛋白 120g + 蔬菜 200g"],
  ...
  },
  {
    ...
    days: [
      ...
      ["周六", "恢复/放纵", "鸡蛋 2个（约100g） + 燕麦 40g干重 + 蓝莓 50g", "虾仁豆腐蔬菜汤：虾仁 120g + 豆腐 200g（半盒） + 生菜 100g", "放纵餐前垫底：蛋白 120g + 蔬菜 200g"],
  ...
  },
  {
    ...
    days: [
      ...
      ["周六", "恢复/放纵", "开放三明治：全麦面包 1片（约35g） + 鸡蛋 1个 + 生菜 80g", "豆腐鸡蛋番茄汤：豆腐 200g（半盒） + 鸡蛋 1个 + 番茄 200g", "放纵餐前垫底：蛋白 120g + 蔬菜 200g"],
  ...
  },
  {
    ...
    shopping: ["荞麦面 300g/包（本周用110g干重，外食另算）", "全麦意面 250g/包（本周用140g干重）", "全麦面包 1袋（约500g）", "燕麦 300g/袋（本周用120g）", "鸡蛋 14个（约700g）", "金枪鱼罐头 1罐（沥干约100g）", "牛肉 500g", "鸡腿肉 600g", "黑虎虾仁 500g", "鲭鱼 2片（150g/片，共300g）", "豆腐 1盒（400g/盒；周六200g、周日200g用完；周二豆腐属于上个买菜周期剩余）", "菠菜 350g", "生菜 500g", "西兰花 400g", "番茄 450g", "彩椒 150g", "洋葱 100g", "紫甘蓝 100g", "黄瓜 200g", "蘑菇 200g", "蓝莓 100g", "橙 1个（约150g）"],
    days: [
      ...
      ["周六", "恢复/放纵", "鸡蛋 2个（约100g） + 燕麦 40g干重 + 蓝莓 50g", "豆腐虾仁沙拉：豆腐 200g（半盒） + 虾仁 120g + 生菜 120g + 全麦面包 1片（约35g）", "放纵餐前垫底：蛋白 120g + 蔬菜 200g"],
  ...
  },
  {
    ...
    days: [
      ...
      ["周六", "恢复/放纵", "鸡蛋 2个（约100g） + 燕麦 40g干重 + 蓝莓 50g", "豆腐虾仁蔬菜汤：豆腐 200g（半盒） + 虾仁 120g + 生菜 100g", "放纵餐前垫底：蛋白 120g + 蔬菜 200g"],
...
function renderPurchasePlan() {
  ...
  const tofuItems = currentWeek().shopping.filter((item) => item.includes("豆腐")).join("、") || "本周不额外买豆腐。";
